...
<div class="card mb-3">
    ...
    <div class="card-body">
      <div class="content-group">
        ...
        <form action="{{route('pengurus.sliderPost')}}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            <div class="form-label-group">
                <input name="judul" type="text" id="judul" class="form-control" placeholder="Judul Slider *" required="required" autofocus="autofocus">
          ...
          <div class="form-group">
            <div class="form-label-group">
                <textarea style="width:100%; height:240px;" id="deskripsi" name="deskripsi" required></textarea>
          ...
          <button style="width:100px;" class="btn btn-primary btn-block" onclick="return confirm('Tambah slider ini?')" type="submit">Simpan</button>
        </form>
      </div>
    </div>
    @endif
